...
class AbstractModel(models.Model):
    ...
    class Meta:
        abstract = True
#  before saving, it clears cached objects for posts/comments, then performs the normal save.
# Automatically manage cache invalidation for posts and comments whenever they are saved or deleted.
# Keep your cache in sync with the database so users don’t see stale data.
