...
class UserManager(BaseUserManager, AbstractManager):
    ...
    def create_superuser(self, username, email, password, **kwargs):
        ...
        user.is_staff = True
        # That line saves the new user into the database, making sure it uses the correct database connection (self._db), especially useful if you ever have more than one database.
        user.save(using=self._db)
...
class User(AbstractBaseUser, PermissionsMixin, AbstractModel):
    ...
    # having a method to create a user and superuse
