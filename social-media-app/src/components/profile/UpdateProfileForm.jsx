...
function UpdateProfileForm(props) {
  ...
  return (
    <div style={{backgroundAttachment:"scroll", backgroundColor: "white", padding:"20px", borderRadius:"10px", boxShadow:"0 4px 18px rgba(159, 8, 164, 0.1)", }}>
    <Form
    ...
    >
      <Form.Group className="mb-3 d-flex flex-column">
        ...
        <Image
          src={avatarUrl || (avatar && URL.createObjectURL(avatar)) || ""}
          roundedCircle
          width={120}
          height={120}
